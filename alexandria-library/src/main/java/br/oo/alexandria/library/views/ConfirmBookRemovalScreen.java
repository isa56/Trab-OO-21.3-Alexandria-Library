...
public class ConfirmBookRemovalScreen extends Screen {
    ...
    public ConfirmBookRemovalScreen(Book book) {
    ...
    private void draw() {
        ...
        textPanel.add(new JLabel("Deseja excluir o livro " + book.getBookName() + "?"));
